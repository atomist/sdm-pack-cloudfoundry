...
/**
 * Cloud Foundry deployment support. Respects any previous deployment goals.
 */
export const CloudFoundryStackSupport: StackSupport = {
    scanners: [cloudFoundryScanner],
    interpreters: [new CloudFoundryDeployInterpreter()],
